...
namespace OPMSProto20202109.Controllers
{
    public class DepartmentsController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Departments.Include(d => d.Division);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DepartmentName,Active,DivisionID,ID,TimeStamp")] Department department)
        {
            if (id != department.ID)
            {
                return NotFound();
